---
title: How To Manage Lists in Redis
date: '2022-10-28'
tags: ['Redis', 'devops']
draft: false
trend: true
summary: Redis is an open-source, in-memory key-value data store. In Redis, a list is a collection of strings sorted by insertion order, similar to linked lists. This tutorial covers how to create and work with elements in Redis lists.
images: []
layout: PostNew
canonicalUrl: canonical/url
postImg: /static/images/manage-lists-in-redis.png
authors: ['beaf']
readTime: '15 min'
category: Devops
---
...
[Redis](https://redis.io/) is an open-source, in-memory key-value data store. In Redis, a [_list_](https://redis.io/topics/data-types#lists) is a collection of strings sorted by insertion order, similar to [linked lists](https://en.wikipedia.org/wiki/Linked_list). This tutorial covers how to create and work with elements in Redis lists.
